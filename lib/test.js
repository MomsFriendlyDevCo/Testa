...
export default class TestaTest {
	...
	* @type {String}
	*/
	_location = '#' + TestaBase.testNumber++;


	/**
	* The associated test file, if any
	*
	* @type {String}
	*/
	_locationFile;
	...
	/**
	* The associated test file line for the test declaration, if any
	*
	* @type {Numebr}
	*/
	_locationLine;
	...
	*/
	depends(...ids) {
		if (!ids.every(a => typeof a == 'string')) throw new Error('All arguments to Testa.depends() must be string IDs');
