...
export class Testa {
	...
	*/
	run(options) {
		...
		if (this._status == 'skipped') return Promise.resolve(); // Already marked as skipped
	...
	*/
	...
	/**
	* Skip this test, optionally providing a reason
	*
	* @param {String} [reason] An optional reason why the test was skipped
	* @returns {Testa} This chainable instance
	*/
	skip(reason) {
		this.abort();
		this._status = 'skipped';
		if (reason) this._skipReason = reason;
		return this;
	}
